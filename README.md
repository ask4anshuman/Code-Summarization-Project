...
- Delta snippets are always rendered as concise, business-readable descriptions for PR comments; raw Added/Removed diff blocks are not shown in the sticky comment.
